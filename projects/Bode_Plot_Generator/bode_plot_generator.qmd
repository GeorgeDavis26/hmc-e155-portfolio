...
The MAX5184 DAC we chose has 10 bits of resolution and a 3.3V power rail as seen on the [datasheet](https://www.digikey.com/en/products/detail/analog-devices-inc-maxim-integrated/MAX5184BEEG/1779540). Therefor the equation for the smallest increment of voltage in a given sample rate is below
...
![Block Diagram of the FPGA, DAC, DUT, MCU, and ESP](images/gantt.jpeg){width=3000}
...
- [ ] The system can handle AT LEAST 0.5 megahertz signals