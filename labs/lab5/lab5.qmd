...
![Figure 2: Calculation to convert number of edges to a rev/sec based on the PPR](images/lab5_revs_calc.jpeg){width=3000}

Figures 1 and 2 show my approach to determening the speed and direction of the motor at evergy edge 
...
![Figure 3: Schematic of physical circuit layout](images/lab5_schem.jpeg){width=3000}

Figure 3 shows the physical layout of the circuit along with the pin names, numbers, and the component values.

## Flowchart

![Figure 4: Flowchart of the general main function process along with the two interrupt trees](images/flow_chart.jpeg){width=3000}
...
![Figure 5: Set of slides to show period of motor at 12 V](images/lab5_slides.jpeg){width=3000}

$$
w = 1 / (0.71-0.36) = 2.857 rad/s
$$

![Figure 6: Osciliscope trace of one pulse off of one of the quadrature encoder pins](images/lab5_oscope.jpeg){width=3000}
